...
from bokeh.models import CheckboxGroup, CheckboxButtonGroup, Slider, RangeSlider, Tabs, TableColumn, DataTable
...
def density_tab(flights):
	...
	def make_dataset(carrier_list, range_start, range_end, bandwidth):
		...
		for i, carrier in enumerate(carrier_list):
			...
			subset = subset[subset['ArrDelay'].between(range_start, 
														range_end)]
	...
	layout = Row(Column(carrier_selection, range_select, 
	 					 bandwidth_select, bandwidth_choose), p)
